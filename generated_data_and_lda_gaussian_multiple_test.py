...
left_part, right_part = 4000,6000
percentage_1 = 0.4
percentage_2 = 0.2
...
for patient in tqdm(range(number_of_patients)):
    ...
    if patient < number_of_patients/patient_phenotypes:
        ...
        first_cell_distrib = np.round([right_part,left_part])
        right_part_column_wth_1, right_part_column_wth_0 = int(percentage_1 * right_part), int((1-percentage_1)*right_part)
        right_part_1_cell_distrib = [right_part_column_wth_1, right_part_column_wth_0]
        third_part_column_with_1, third_part_column_wth_0 = int(percentage_2 * left_part), int((1-percentage_2) * left_part)
        right_part_2_cell_distrib = [third_part_column_with_1, third_part_column_wth_0]

        first_colum = [1] * right_part + [0] *left_part
        second_column_test = [1] * right_part_1_cell_distrib[0]+ [0] * right_part_1_cell_distrib[1] + [1] * right_part_2_cell_distrib[0] + [0] *right_part_2_cell_distrib[1]


    phenotype_binary_data_patient = pd.DataFrame( {'Col1': first_colum, 'Col2': second_column_test})
